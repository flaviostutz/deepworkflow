...
def increment_batch_repeat_step(state: file_batch_workflow_state) -> dict:
    ...
    accumulates execute_output into cumulative_execute_output,
    ...
    existing_previous = state.get("cumulative_execute_output", "")
    ...
    return {
        ...
        "cumulative_execute_output": cumulative_execute_output,
